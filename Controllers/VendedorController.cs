...
namespace LojaDeHardware.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendedorId,VendedorNome,VendedorCPF")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorId,VendedorNome,VendedorCPF")] Vendedor vendedor)
        {
