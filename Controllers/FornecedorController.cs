...
namespace LojaDeHardware.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,FornecedorCNPJ,FornecedorNome")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FornecedorId,FornecedorCNPJ,FornecedorNome")] Fornecedor fornecedor)
        {
