...
namespace LojaDeHardware.Controllers
{
    public class VendaHasProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendaHasProdutoId,VendaHasProdutoQtd,VendaId,ProdutoId")] VendaHasProduto vendaHasProduto)
        {
            ...
            ViewData["VendaId"] = new SelectList(_context.Venda, "VendaId", "VendaId", vendaHasProduto.VendaId);
            return View(vendaHasProduto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendaHasProdutoId,VendaHasProdutoQtd,VendaId,ProdutoId")] VendaHasProduto vendaHasProduto)
        {
